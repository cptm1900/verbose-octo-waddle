...
@WebServlet("/profilePhotoView")
public class profilePhotoView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(image==null || !imageFile.exists() ||image == "" || "null".equalsIgnoreCase(image)) {
			imageFile = new File(file,"avatar.webp");
		}
