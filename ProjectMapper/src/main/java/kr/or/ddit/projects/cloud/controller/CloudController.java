...
public class CloudController {
	...
	@GetMapping("{pjId}")
	public String cloudex(@PathVariable String pjId, Model model) {
		pjId = pjId.toLowerCase();
//		List<CloudResourceVO> cloudResourceList = crService.readCloudResourceList("p0200001");
//		List<CloudResourceVO> cloudResourceList = crService.readSideFileList("p0200001");
