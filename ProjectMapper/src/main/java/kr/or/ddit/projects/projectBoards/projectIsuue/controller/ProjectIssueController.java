...
//		String content = issueDetail.getIssueContent().replace("\n", "<br/>");
//		issueDetail.setIssueContent(content);
...
//	@ResponseBody
//	@GetMapping("{pjId}")
//	public List<IssueVO> readIssueList(@PathVariable String pjId) {
//		return service.readIssueList(pjId);
//	}
