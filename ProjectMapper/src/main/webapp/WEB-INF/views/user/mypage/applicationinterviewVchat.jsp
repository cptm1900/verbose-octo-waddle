...
<ol class="breadcrumb mb-0">
	<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/interview/mypage/${user}">면접일정</a></li>
					...
					<div class="container-small py-3">
						<div
							...
							<a value="방나가기" class="btn btn-primary flex-1 text-nowrap"
								 id="button-leave" onmouseup="leaveRoom();" href="${pageContext.request.contextPath}/interview/mypage/${projectMember.pjId}"
