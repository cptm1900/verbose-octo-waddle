...
<!-- 캘린더 생성 위치 -->
<div id='calendar-container' data-context-path="${pageContext.request.contextPath}" data-user-id="${userId}">
	<div id='calendar'></div>
</div>
...
<!-- 프로젝트 업무 조회 모달 -->
<div class="modal fade" id="addEventModal_move" tabindex="-1" aria-labelledby="addEventModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEventModalLabel_move">업무</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="eventForm_move">
                    <div class="mb-3">
                        <label for="title_move" class="form-label">업무 제목</label>
                        <input type="text" class="form-control" id="title_move" required>
                    </div>
                    <div class="mb-3">
                        <label for="content_move" class="form-label">업무 내용</label>
                        <input type="text" class="form-control" id="content_move" required>
                    </div>
                    <div class="mb-3">
                        <label for="start_move" class="form-label">시작 일자</label>
                        <input type="date" class="form-control" id="start_move" required>
                    </div>
                    <div class="mb-3">
                        <label for="end_move" class="form-label">마감 일자</label>
                        <input type="date" class="form-control" id="end_move" required>
                    </div>
                    <button type="button" id="scheduleModal_move" class="btn btn-primary">이동</button>
                    <button type="button" id="scheduleModalCancel_move" class="btn btn-secondary">취소</button>
                </form>
            </div>
        </div>
    </div>
