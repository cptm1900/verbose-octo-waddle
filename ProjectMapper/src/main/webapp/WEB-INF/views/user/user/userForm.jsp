...
.form-control:focus {
   border-color: #86b7fe;     /* 포커스시 테두리 색상 */
   box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);  /* 포커스시 그림자 효과 */
}
...
.input-group {
   ...
   flex-wrap: nowrap !important;  /* 버튼이 절대 줄바꿈 되지 않도록 강제 */
...
.input-group > .form-control {
   flex: 1;                    /* 단순화 */
   min-width: 0;               /* 최소 너비 유지 */
   height: 50px;               /* 높이 고정 */
}

/* input-group 내부의 버튼 스타일 */
.input-group > .btn {
   border-top-left-radius: 0 !important;     /* 왼쪽 입력창과 맞닿는 부분의 라운드 제거 */
   border-bottom-left-radius: 0 !important;
   z-index: 2;                               /* 버튼을 입력창보다 위에 표시 */
   height: 50px;                             /* 버튼 높이 고정 */
}

/* input-group 내부 메시지 위치 조정 */
.input-group + .message-div {
   bottom: -28px;              /* input-group 아래 여백 조정 */
}

/* 애니메이션 효과 */
.fade-in {
   animation: fadeIn 0.3s ease-in;  /* 페이드인 애니메이션 적용 */
}

@keyframes fadeIn {
   from {
       opacity: 0;              /* 시작시 투명 */
       transform: translateY(-10px);  /* 시작시 위치 */
   }
   to {
       opacity: 1;              /* 종료시 불투명 */
       transform: translateY(0);  /* 종료시 위치 */
   }
}
.text-muted {
                ...
                <div class="card-body">
                    <form id="joinForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="step-content" data-step="2">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-auto">
                                        <div class="avatar avatar-4xl">
                                            <img class="rounded-circle" src="${pageContext.request.contextPath}/resources/phoenix-v1.20.1/public/assets/img/team/avatar.webp" alt="Profile" id="profilePreview">
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="dropzone-area px-2 py-3">
                                            <div class="text-center">
                                                ...
                                                <input type="file" class="d-none" id="uploadFiles" name="uploadFiles" accept="image/*">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label required-field">생년월일</label>
                                <div class="row g-2">
                                    <div class="col-sm-4">
                            ...
                            <div class="mb-3">
                                <label for="userPhoneNumber" class="form-label required-field">전화번호</label>
                                <input type="tel" class="form-control" id="userPhoneNumber" name="userPhoneNumber" placeholder="010-0000-0000" required>
                            </div>
...
<script src="${pageContext.request.contextPath}/resources/js/user/userForm.js"></script>
