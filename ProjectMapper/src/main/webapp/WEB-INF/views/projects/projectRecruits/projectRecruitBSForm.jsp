		...
		<div class="col-xl-6">
			<div class="card stretch stretch-full">
				<div class="card-body">
					<div class="mb-4">
					   <div class="mb-4">
						    <label class="form-label">공고 시작일자<span class="text-danger">*</span></label> 
					...
					<div class="mb-4">
					    ...
					    <label class="form-label">공고 종료일자<span class="text-danger">*</span></label> 
			...
			<div class="table-responsive">
				<table class="table table-bordered overflow-hidden" id="tab_logic">
					...
					<tbody id="tab_logic_body">
					    <tr>
				            <td>1</td>
				                <td><input type="text" name="positions[0].positionName" placeholder="포지션명" class="form-control" /></td>
				                <td><input type="text" name="positions[0].positionReq" placeholder="자격요건" class="form-control" /></td>
				                <td><input type="number" name="positions[0].positionPeopleCount" placeholder="모집인원" class="form-control" min="1" /></td>
			            </tr>
