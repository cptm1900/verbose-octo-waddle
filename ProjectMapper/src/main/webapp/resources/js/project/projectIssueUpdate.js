...
document.addEventListener("DOMContentLoaded", async () => {
	...
	const afi = document.body.dataset.afi;
	const issueFetch = new ProjectFetch(`${contextPath}/project/issue/update`);
	const atchFetch = new ProjectFetch(`${contextPath}/atch`);
	const updateIssueForm = document.querySelector("#updateIssueForm");
	console.log(afi)
	// 해당 이슈 파일목록 불러오기
	// 삭제 번호담기
	let filesToDelete = [];
